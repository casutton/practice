...
Profiles let you separate practice data for different musicians or practice contexts.
...
<div class="flow-step">
    <span class="step-number">1</span>
    <strong>Enable instrument tracking</strong>
...
<div class="flow-step">
    <span class="step-number">1</span>
    <strong>Open Bucket Settings</strong>
...
Configure what statistics appear on your practice dashboard.
...
<div class="flow-step">
    ...
    <p>Choose from available app icons. The change takes effect immediately.</p>
</div>
