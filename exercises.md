...
layout: default
title: Exercises
description: Creating and practicing exercises in FolkTunesApp
---
...
<div class="flow-step">
    ...
    <strong>Save the exercise</strong>
    <p>Tap "Save" to add the exercise to your library.</p>
</div>
...
<div class="flow-step">
    <span class="step-number">3</span>
    <strong>Practice the exercise</strong>
    <p>Use the same practice tools (metronome, timer, etc.) as you would for tunes.</p>
</div>
...
<div class="flow-step">
    <span class="step-number">1</span>
    <strong>Open an exercise</strong>
    <p>From the Exercises view, tap on an exercise to view its details.</p>
</div>
